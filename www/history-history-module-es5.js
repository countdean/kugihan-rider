...
module.exports = "h3 {\n  font-weight: 500;\n}\n\n.currency {\n  color: #4caf50;\n  font-weight: 500;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HistoryPage = /** @class */ (function () {
    function HistoryPage(common, tripService, translate, router) {
        this.common = common;
    ...
    HistoryPage.prototype.getTrips = function () {
        var _this = this;
        this.common.showLoader();
        this.tripService.getTrips().valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1)).subscribe(function (snapshot) {
            if (snapshot != null)
                _this.trips = snapshot.reverse();
            _this.common.hideLoader();
        });
    };
    HistoryPage.prototype.viewTrip = function (trip) {
