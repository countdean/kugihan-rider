...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, translate, afAuth, authService, router, tripService) {
...
let RatingPage = class RatingPage {
    constructor(tripService, common, navParams, modalCtrl) {
        this.tripService = tripService;
        this.common = common;
...
let AuthService = class AuthService {
    ...
    createUserIfNotExist(user) {
        this.getUser(user.uid).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe((snapshot) => {
            if (snapshot === null) {
...
let CommonService = class CommonService {
    constructor(toastCtrl, loadCtrl, alertCtrl, translate) {
...
let SHOW_VEHICLES_WITHIN = 20;
let POSITION_INTERVAL = 10 * 1000;
let VEHICLE_LAST_ACTIVE_LIMIT = 2 * 60 * 1000; // 2 mins
...
let DEAL_TIMEOUT = 20 * 1000; // 20s
let ENABLE_SIGNUP = true;
let SOS = "100";
let DEFAULT_AVATAR = "http://placehold.it/150x150";
const environment = {
    production: true,
    appName: 'Kugihan',
    firebase: {
