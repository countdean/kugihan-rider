...
/***/ "./node_modules/raw-loader/index.js!./src/app/rating/rating.page.html":
/*!*******************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/rating/rating.page.html ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["take"])(1)).subscribe(function (authData) {
                if (authData) {
                    ...
                    _this.tripService.getTrips().valueChanges().subscribe(function (trips) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_fire__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_13__["environment"].firebase),
                ...
                _rating_rating_module__WEBPACK_IMPORTED_MODULE_20__["RatingPageModule"],
...
/* harmony import */ var ionic_rating__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ionic-rating */ "./node_modules/ionic-rating/fesm5/ionic-rating.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_trip_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/trip.service */ "./src/app/services/trip.service.ts");
...
var RatingPage = /** @class */ (function () {
    ...
    RatingPage.prototype.onRateChange = function (event) {
        console.log(event);
        this.rating = event;
    };
    RatingPage.prototype.rateTrip = function () {
        var _this = this;
        console.log(this.rating);
        this.tripService.rateTrip(this.trip.key, this.rating, this.feedback).then(function () {
            _this.common.showToast("Thanks for your rating");
            _this.tripService.finishTrip(_this.trip.key);
    ...
    RatingPage.prototype.skip = function () {
    ...
    RatingPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-rating',
            template: __webpack_require__(/*! raw-loader!./rating.page.html */ "./node_modules/raw-loader/index.js!./src/app/rating/rating.page.html"),
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.register = function (email, password, name, phoneNumber) {
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"].create(function (observer) {
            _this.afAuth.auth.createUserWithEmailAndPassword(email, password).then(function (authData) {
                ...
                _this.updateUserProfile(userInfo);
                observer.next();
    ...
    AuthService.prototype.updateUserProfile = function (user) {
        ...
        var photoUrl = user.photoURL ? user.photoURL : src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_4__["DEFAULT_AVATAR"];
    ...
    AuthService.prototype.createUserIfNotExist = function (user) {
        var _this = this;
        this.getUser(user.uid).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe(function (snapshot) {
            if (snapshot === null) {
    ...
    AuthService.prototype.loginFbRegister = function (authData) {
        console.log(authData);
        var user = this.afAuth.auth.currentUser;
        var existing = this.db.object('drivers/' + user.uid);
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_3__["AngularFireDatabase"]])
    ], AuthService);
    return AuthService;
}());
...
var CommonService = /** @class */ (function () {
    ...
    CommonService.prototype.showToast = function (message) {
        this.toastCtrl.create({ message: message, duration: 3000 }).then(function (res) { return res.present(); });
    };
    CommonService.prototype.showAlert = function (message) {
    ...
    CommonService.prototype.showLoader = function () {
        var _this = this;
        if (this.loader == null) {
            this.loadCtrl.create({ spinner: 'circles', duration: 5000 }).then(function (res) {
                _this.loader = res;
    ...
    CommonService.prototype.changeLang = function (lang) {
        this.translate.use(lang);
        localStorage.setItem('lang', lang);
    };
    CommonService.prototype.getLang = function () {
        var lang = localStorage.getItem('lang');
        if (lang == null || lang == undefined)
            return 'en';
        else
...
/* harmony import */ var _place__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./place */ "./src/app/services/place.ts");
...
var TripService = /** @class */ (function () {
    ...
    TripService.prototype.setDropOff = function (vicinity, lat, lng, index) {
        var place = new _place__WEBPACK_IMPORTED_MODULE_4__["Place"](vicinity, lat, lng);
        console.log(index);
        return this.dropOff[index] = place.getFormatted();
    };
    TripService.prototype.removeDropOff = function (index) {
        //remove properly 
        var self = this;
        var temp = [];
    ...
    TripService.prototype.setRawFee = function (fee) {
        return this.rawfee = fee;
    };
    TripService.prototype.getRawFee = function () {
        return this.rawfee;
    };
    TripService.prototype.setTax = function (tax) {
        return this.tax = tax;
    };
    TripService.prototype.getTax = function () {
        return this.tax;
    };
    TripService.prototype.setFeeTaxed = function (fee_taxed) {
        return this.fee_taxed = fee_taxed;
    };
    TripService.prototype.getFeeTaxed = function () {
        return this.fee_taxed;
    };
    TripService.prototype.setCommissionType = function (commission_type) {
        return this.commission_type = commission_type;
    };
    TripService.prototype.getCommissionType = function () {
        return this.commission_type;
    };
    TripService.prototype.setCommission = function (commission) {
        return this.commission = commission;
    };
    TripService.prototype.getCommission = function () {
        return this.commission;
    };
    TripService.prototype.setCommissionValue = function (commission_value) {
        return this.commission_value = commission_value;
    };
    TripService.prototype.getCommissionValue = function () {
    ...
    TripService.prototype.getTrips = function () {
        ...
        console.log(user);
        return this.db.list('trips', function (res) { return res.orderByChild('passengerId').equalTo(user.uid); });
    };
    ...
    TripService.prototype.rateTrip = function (tripId, stars, feedback) {
...
/*!**********************************************!*\
  !*** ./src/environments/environment.prod.ts ***!
  \**********************************************/
/*! exports provided: SHOW_VEHICLES_WITHIN, POSITION_INTERVAL, VEHICLE_LAST_ACTIVE_LIMIT, DEAL_STATUS_PENDING, DEAL_STATUS_ACCEPTED, TRIP_STATUS_GOING, TRIP_STATUS_FINISHED, TRIP_STATUS_CANCELED, DEAL_TIMEOUT, ENABLE_SIGNUP, SOS, DEFAULT_AVATAR, environment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SHOW_VEHICLES_WITHIN", function() { return SHOW_VEHICLES_WITHIN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "POSITION_INTERVAL", function() { return POSITION_INTERVAL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VEHICLE_LAST_ACTIVE_LIMIT", function() { return VEHICLE_LAST_ACTIVE_LIMIT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEAL_STATUS_PENDING", function() { return DEAL_STATUS_PENDING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEAL_STATUS_ACCEPTED", function() { return DEAL_STATUS_ACCEPTED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRIP_STATUS_GOING", function() { return TRIP_STATUS_GOING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRIP_STATUS_FINISHED", function() { return TRIP_STATUS_FINISHED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRIP_STATUS_CANCELED", function() { return TRIP_STATUS_CANCELED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEAL_TIMEOUT", function() { return DEAL_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ENABLE_SIGNUP", function() { return ENABLE_SIGNUP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SOS", function() { return SOS; });
